...
@section('content')
    ...
    <div class="profil">
        ...
        <div class="form-section">
            <form action="{{route('userModify')}}" method="post" role="form" class="form-inline">
                @csrf
                <div class="nev row">
                ...
                <div class="passwd row">
                    <label for="password_new" class="col-lg-4 col-form-label">Jelszó</label>
                    <div class="col-lg-8">
                        <input type="password" name="password_new" class="form-control input" placeholder="*************">
                    </div>
                </div>
                <div class="passwd row">
                    <label for="password_new_confirmation" class="col-lg-4 col-form-label">Jelszó megerősítése</label>
                    <div class="col-lg-8">
